...
const PastCS = (props) => {
  ...
  export async function getServerSideProps({ query }) {
    ...
    const response = await fetch(
      `https://api.pandascore.co/matches/past?sort=&page=${page}&per_page=10&filter[videogame]=cs-go&token=a1trG0pytDA2N0RXkJVlWqA6MOb2aY8ii9szwMze-OabnW9QPu0`
    );
  ...
  export default withRouter(PastCS);