...
export async function getServerSideProps() {
    ...
    const valresult = await fetch(`https://api.pandascore.co/matches/past?filter[videogame]=cs-go&token=a1trG0pytDA2N0RXkJVlWqA6MOb2aY8ii9szwMze-OabnW9QPu0`);
